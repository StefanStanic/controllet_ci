...
<div class="container">
    <h2 align="center">Add a custom bill</h2>
...
<?php }
        ...
        echo '<h3 align="center">You are only allowed here, using our application</h3>';
        echo '<a href="'.base_url().'/dashboard/"><h2 align="center">Go back</h2></a>';
    }