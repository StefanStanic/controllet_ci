...
<div class="container">
    ...
    <?php echo form_open('dashboard/update_rec_bill_validation');?>
    <?php
    ...
    foreach ($bill as $row) {
        ...
        echo form_dropdown('category',$option,'Phone');
        ...
        echo '<br/>';
        echo '<p align="center"><button class="btn btn-lg btn-primary" type="submit">Update Bill</button></p>';
    }
    ?>
    <?php echo form_close();?>
