...
--
-- Host: localhost:8889
-- Generation Time: Jan 12, 2018 at 02:32 AM
...
--
-- Table structure for table `custom_bill`
--

CREATE TABLE `custom_bill` (
...
--
-- Dumping data for table `custom_bill`
--

INSERT INTO `custom_bill` (`custom_id`, `amount`, `description`, `date_added`, `category`, `id_user`) VALUES
(1, 10, 'kola', '2018-01-12', 'custom', 27);
...
(8, '2018-01-10', '4', 22, 27),
(9, '2018-01-10', '2', 32, 27);
...
--
-- Indexes for table `custom_bill`
--
ALTER TABLE `custom_bill`
  ADD PRIMARY KEY (`custom_id`),
  ADD KEY `fk_user_custom` (`id_user`);
...
--
-- AUTO_INCREMENT for table `custom_bill`
--
ALTER TABLE `custom_bill`
...
--
ALTER TABLE `recurring_montly_bills`
  MODIFY `id_montly_bills` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
--
...
--
-- Constraints for table `custom_bill`
--
ALTER TABLE `custom_bill`
  ADD CONSTRAINT `fk_user_custom` FOREIGN KEY (`id_user`) REFERENCES `users` (`id_user`);
